...
({
    ...
    */
    createTypeaheadComponent: function(component){
        ...
        .bind('typeahead:selected', 
			function(evnt, suggestion){
                //alert(suggestion.id+"=id value="+suggestion.value);
    ...
    /*
     * This will call "searchSObject" apex method to search SObject "User"
     */
    searchAction : function(component, q){
        ...
        action.setCallback(this, function(a) {
            ...
            if (state!="SUCCESS")
            {
                if (state=="INCOMPLETE"){
                    //swallow this error
                    //users can keep typing and auto-complete will resume
                    //perhaps there were overlapping callbacks?
                }
                else{
		            this.traceResponseErrors(a, "searchAction.callback");
                }
                return;
            }
