...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>unfiled$public/HRM_Case_Reminder_15_Day_Email</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_Case_Reminder_15_Day_Email_for_60_Day_Deadline</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_Case_Reminder_45_Day_Email_for_60_Day_Deadline</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_Case_Notification_Initial_Email</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_Case_Reminder_10_Day_Email</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_OIG_Case_Reminder_30_Day_Email</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_OIG_Case_Assignment_Notification_Email_for_Assigned_Specialist</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_OIG_Case_Assignment_Notification_Email_ROO_AO</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/HRM_OIG_Case_Notification_Ready_for_Action_Officer_to_View</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        ...
        <field>OwnerId</field>
        <lookupValue>HRM_Case_Queue</lookupValue>
    ...
    <rules>
        ...
        <workflowTimeTriggers>
            ...
            <offsetFromField>HR_Case__c.HRM_Date_Received__c</offsetFromField>
    ...
    <rules>
        ...
        <workflowTimeTriggers>
            ...
            <offsetFromField>HR_Case__c.HRM_Date_MGMT_HR_Agree_to_Action__c</offsetFromField>
            <timeLength>15</timeLength>
            <workflowTimeTriggerUnit>Days</workflowTimeTriggerUnit>
        </workflowTimeTriggers>
        <workflowTimeTriggers>
    ...
    <rules>
        ...
        <workflowTimeTriggers>
            ...
            <offsetFromField>HR_Case__c.HRM_Date_MGMT_HR_Agree_to_Prop_Action__c</offsetFromField>
            <timeLength>30</timeLength>
            <workflowTimeTriggerUnit>Days</workflowTimeTriggerUnit>
        </workflowTimeTriggers>
        <workflowTimeTriggers>
    ...
    <rules>
        ...
        <workflowTimeTriggers>
            <actions>
                <name>HRM_Case_15_Day_Notification_for_60_Day_Deadline</name>
                <type>Alert</type>
            </actions>
            <offsetFromField>HR_Case__c.HRM_Date_MGMT_HR_Agree_to_Prop_Action__c</offsetFromField>
            <timeLength>15</timeLength>
    ...
    <rules>
        ...
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <offsetFromField>HR_Case__c.CreatedDate</offsetFromField>
            <timeLength>30</timeLength>
            <workflowTimeTriggerUnit>Days</workflowTimeTriggerUnit>
        </workflowTimeTriggers>
        <workflowTimeTriggers>
